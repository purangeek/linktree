                    ...
                    <div class="action-area">
                        <div class="action-primary">
                                ...
                                <div class="link-header-wp">
                                    <ul>
                                        ...
                                        <li class="form-item">
                                            ...
                                            <div class="form-input-hover"></div>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="addlink-box-wp">
                                            <div class="addlink-box">
                                                ...
                                                <div class="addlink-right-content">
                                                    ...
                                                    <div class="addlink-con-inr-top" data-link_id="{{ $link->id }}">
                                                        <div class="addlink-con-title">
                                                            <input type="text" class="input-addlink-title" name="title" value="{{ $link->link_title }}">
                                                            @if($link->link_title == '')
                                                                <span class="addlink-con-title-text">Link Name</span> 
                                                            @else
                                                                <span class="addlink-con-title-text">{{ $link->link_title }}</span>
                                                            @endif
                                                        ...
                                                        <div class="addlink-con-link">
                                                            <input type="text" class="input-addlink-link" name="link" value="{{ $link->link_url }}">
                                                            @if($link->link_url == '')
                                                                <span class="addlink-con-link-text">https://url.com</span>
                                                            @else
                                                                <span class="addlink-con-link-text">{{ $link->link_url }}</span>
                                                            @endif
                                                            <button class="add-edit-button">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                                                                    <path id="edit-button" d="M19.985,5.464,16.7,2.155a1.157,1.157,0,0,0-1.635,0L3.413,13.81l-1.064,4.6a1.155,1.155,0,0,0,1.12,1.4,1.2,1.2,0,0,0,.241,0l4.641-1.066L19.985,7.1A1.162,1.162,0,0,0,19.985,5.464ZM7.791,17.736l-4.35.914.991-4.274,8.717-8.7,3.359,3.365ZM17.258,8.23,13.9,4.864l1.948-1.941,3.3,3.365Z" transform="translate(-2.322 -1.817)" />
                            ...
                            <div class="tab-box themes-tab-box">
                                ...
                                <div class="tab-box-inner themes-inner-box">
                                    <div class="tab-title">
                                ...
                                <div class="tab-box-inner background-inner-box">
                                    <div class="tab-title">
                                ...
                                <div class="tab-box-inner buttons-inner-box">
                                    <div class="tab-title">
                                    ...
                                    <div class="buttons-box">
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fill">
                                                    <div class="buttons-preview white">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fillrounded">
                                                    <div class="buttons-preview white">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fillcircular">
                                                    <div class="buttons-preview white">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-outline">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-outlinerounded">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-outlinecircular">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-doubleoutline">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-doubleoutlinerounded">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-doubleoutlinecircular">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-dashedoutline">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-dashedoutlinerounded">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-dashedoutlinecircular">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-hardshadow">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-hardshadowrounded">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-hardshadowcircular">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-softshadow">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-softshadowrounded">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-softshadowcircular">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fillarrowright-overflow-hide">
                                                    <div class="buttons-preview white">Button</div>
                                                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fillarrowrightrounded-overflow-hide">
                                                    <div class="buttons-preview white">Button</div>
                                                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fillarrowrightcircular-overflow-hide">
                                                    <div class="buttons-preview white">Button</div>
                                                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="buttons-preview-row">
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-formal-2-stroke">
                                                    <div class="buttons-preview">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fill-topbottom-stroke">
                                                    <div class="buttons-preview white">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fill-torn-edges">
                                                    <div class="buttons-preview white">Button</div>
                                                </div>
                                            </div>
                                            <div class="buttons-preview-col">
                                                <div class="buttons-preview-col-inner buttons-preview-fill-box-border">
                                                    <div class="buttons-preview white">Button</div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-box-inner font-inner-box">
                                    <div class="tab-title">
                    ...
                    <div class="toolbar-mf-box">
                        <div class="toolbar-mf-header">
                            ...
                            <div class="toolbar-mf-header-content">
                                <h4 class="h4-title">{{Auth::user()->name}}</h4>
                        ...
                        <div class="toolbar-mf-button-group">
                            <ul>
                            @foreach($links as $link)
                                @if(($link->link_title != '') && ($link->link_url != ''))
                                    <li>
                                        <a href="{{$link->link_title}}" class="toolbar-mf-btn"><span>{{$link->link_title}}</span></a>
                                    </li>
                                @endif
                            @endforeach
                            </ul>
